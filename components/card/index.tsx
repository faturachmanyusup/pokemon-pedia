...
export const PokemonCard = forwardRef((props: PokemonCardProps, ref: ForwardedRef<HTMLAnchorElement>): JSX.Element => {
  return (
    <a lang="en" href={props.href} ref={ref} data-testid="pokemon-card">
      ...
      >
        ...
        >
          <h3 css={mq({ textTransform: 'capitalize', fontSize: [24, 24, 16] })} data-testid="card-id">{props.labelLeft}</h3>
